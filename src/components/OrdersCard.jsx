...
const OrdersCard = () => {
  ...
  return (
    <div className="w-full p-4 bg-white dark:bg-black border border-[#EDF2F7] dark:border-white/35 rounded-xl col-span-5 lg:col-span-3 overflow-auto max-w-[800px] transition-all duration-300 ease-in-out self-start">
        ...
        <div className="w-full overflow-x-auto lg:overflow-hidden transition-all duration-300 ease-in-out">
            <div className="w-full flex items-center justify-start py-3">
                ...
                <h4 className="text-[#9CA4AB] mr-[30px] lg:mr-[52px]">Status</h4>
