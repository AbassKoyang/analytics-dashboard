    ...
    <aside className="py-5 flex flex-col items-center gap-2.5 bg-[#F7F8FA] border-r border-r-[#EBECF2] h-full">
      ...
      <div className="flex flex-col items-center justify-center gap-1">
        ...
        <button className="size-10 flex items-center justify-center mx-2.5">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#0D062D" aria-hidden={true}  className="link-svg">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none" aria-hidden={true} className="active-svg">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none" aria-hidden={true}>
          <path d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
        </svg>
        </Link>
