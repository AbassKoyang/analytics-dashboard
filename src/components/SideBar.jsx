...
const SideBar = () => {
  ...
  return (
    <aside className="hidden lg:flex fixed top-0 left-0 py-5 flex-col items-center justify-between bg-[#F7F8FA] dark:bg-[#1b1b1b] border-r border-r-[#EBECF2] dark:border-r-[#A3A3A3] h-full">
