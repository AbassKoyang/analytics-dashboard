...
const SideBar = () => {
  ...
  return (
    <aside className="fixed top-0 left-0 py-5 flex flex-col items-center justify-between bg-[#F7F8FA] dark:bg-[#1b1b1b] border-r dark:border-0 border-r-[#EBECF2] h-full">
