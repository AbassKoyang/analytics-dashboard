  ...
  return (
      <nav className="w-full flex lg:hidden fixed bottom-0 left-0 items-center justify-center gap-1 py-4 border-t border-t-[#EBECF2] dark:border-t-[#A3A3A3] bg-[#F7F8FA] dark:bg-[#1b1b1b]">
        ...
        <Link to='trends' aria-label="Link to trends" className="flex flex-col items-center justify-between group">
          <button className={`size-9 md:size-12 lg:size-9 xl:size-10 flex items-center justify-center rounded-sm hover:p-2 mx-2 xl:mx-2.5 ${location.pathname === '/trends' ? 'bg-[#0D062D] dark:bg-[#34CAA5] p-2' : 'bg-transparent'} group-hover:bg-[#0D062D] group-hover:dark:bg-[#34CAA5] transition-all duration-200 ease-in-out`}>
        ...
        <Link to='profile' aria-label="Link to profile page" className="flex flex-col items-center justify-between group">
          <button className={`size-9 md:size-12 lg:size-9 xl:size-10 flex items-center justify-center rounded-sm hover:p-2 mx-2 xl:mx-2.5 ${location.pathname === '/profile' ? 'bg-[#0D062D] dark:bg-[#34CAA5] p-2' : 'bg-transparent'} group-hover:bg-[#0D062D] group-hover:dark:bg-[#34CAA5] transition-all duration-200 ease-in-out`}>
        ...
        <Link to='chart' aria-label="Link to chart page" className="flex flex-col items-center justify-between group">
          <button className={`size-9 md:size-12 lg:size-9 xl:size-10 flex items-center justify-center rounded-sm hover:p-2 mx-2 xl:mx-2.5 ${location.pathname === '/chart' ? 'bg-[#0D062D] dark:bg-[#34CAA5] p-2' : 'bg-transparent'} group-hover:bg-[#0D062D] group-hover:dark:bg-[#34CAA5] transition-all duration-200 ease-in-out`}>
        ...
        <Link to='discount' aria-label="Link to discount page" className="flex flex-col items-center justify-between group">
          <button className={`size-9 md:size-12 lg:size-9 xl:size-10 flex items-center justify-center rounded-sm hover:p-2 mx-2 xl:mx-2.5 ${location.pathname === '/discount' ? 'bg-[#0D062D] dark:bg-[#34CAA5] p-2' : 'bg-transparent'} group-hover:bg-[#0D062D] group-hover:dark:bg-[#34CAA5] transition-all duration-200 ease-in-out`}>
        ...
        <Link to='info' aria-label="Link to info page" className="flex flex-col items-center justify-between group">
          <button className={`size-9 md:size-12 lg:size-9 xl:size-10 flex items-center justify-center rounded-sm hover:p-2 mx-2 xl:mx-2.5 ${location.pathname === '/info' ? 'bg-[#0D062D] dark:bg-[#34CAA5] p-2' : 'bg-transparent'} group-hover:bg-[#0D062D] group-hover:dark:bg-[#34CAA5] transition-all duration-200 ease-in-out`}>
