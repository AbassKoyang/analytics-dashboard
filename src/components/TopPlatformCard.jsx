...
const TopPlatformCard = () => {
  ...
  return (
    <section className="col-span-5 lg:col-span-2 p-4 bg-white dark:bg-black border border-[#EDF2F7] dark:border-white/35 self-start transition-all duration-300 ease-in-out">
