...
import { BoxIcon, CartIcon, CoinIcon, RefundIcon, TrendDownIcon, TrendUpIcon } from "../assets/icons.jsx"
...
const Home = () => {
  return (
    ...
    <section className="w-full grid grid-cols-5 gap-5 bg-[#FAFAFA] dark:bg-[#1b1b1b] mt-5">
      <ChartCard />
