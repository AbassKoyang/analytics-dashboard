...
const Home = () => {
  return (
    ...
    <section className="w-full max-w-[1400px] grid grid-cols-5 gap-5 bg-[#FAFAFA] dark:bg-[#1b1b1b]">
      ...
      <StatsCard graph={totalOrderGraph} icon={<BoxIcon />} heading='Total Order' value='350' percentage='23.5%' trendIcon={<TrendUpIcon />} text='vs. previous month' textColor='text-[#34CAA5]' backGroundColor='bg-[#34caa43a]'  />
